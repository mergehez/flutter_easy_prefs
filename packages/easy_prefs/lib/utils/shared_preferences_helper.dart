...
class SharedPreferencesHelper {
  ...
  NotifiableStringList getStringList(String key, List<String> defaultValue) {
    return NotifiableStringList(_prefs.getStringList(key) ?? defaultValue,
  ...
  TEnum getEnum<TEnum extends Enum>(
      String key, List<TEnum> allEnumValues, TEnum defaultValue) {
  ...
  bool hasKeyByValueCheck(String key, String defaultValue) =>
      (_prefs.getString(key) ?? defaultValue) != defaultValue;
}
